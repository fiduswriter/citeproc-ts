import { DATE_VARIABLES, NAME_VARIABLES, MODULE_MACROS } from '../constants/core';
import { NOTE_FIELDS_REGEXP, NOTE_FIELD_REGEXP, ALL_ROMANESQUE_REGEXP } from '../constants/regex';
import { dateParserInstance } from './dateparser';
import { parseParticles } from './name_particles';
import { Output_formats } from '../output/formats';
import { Parallel } from './parallel';

export function checkNestedBrace(state: CslState): void {
...
export function parseLocator(this: any, item: any): any {
...
export function parseNoteFieldHacks(Item: any, validFieldsForType: any, allowDateOverride: boolean): void {
...
export function getSafeEscape(state: CslState): (txt: string) => string {
...
export function EVALUATE_GROUP_CONDITION(state: CslState, flags: any): boolean {
...
export function GET_COURT_CLASS(state: CslState, Item: any, sortKey?: any): string {
    let cls = "";
    let authority = null;
...
export function SET_COURT_CLASSES(state: CslState, lang: string, myxml: any, dataObj: any): void {
...
export function INIT_JURISDICTION_MACROS(state: CslState, Item: any, item: any, macroName: string): boolean {

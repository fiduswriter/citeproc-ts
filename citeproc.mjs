        ...
        for (let i = 0, ilen = lines.length; i < ilen; i++) {
          ...
          if (m) {
            ...
            for (let j = 1, jlen = elems2.length; j < jlen; j += 2) {
              if (elems2[j - 1].trim() && (i > 0 || j > 1) && !elems2[j - 1].match(CSL.NOTE_FIELD_REGEXP)) {
                break;
              } else {
...
var AREAS, ASCENDING, ASSUME_ALL_ITEMS_REGISTERED, CITE_FIELDS, DATE_PARTS, DATE_PARTS_ALL, DATE_PARTS_INTERNAL, DATE_VARIABLES, DESCENDING, DISPLAY_CLASSES, END, ERROR_NO_RENDERED_FORM, FIELD_CATEGORY_REMAP, FORMAT_KEY_SEQUENCE, GENDERS, GIVENNAME_DISAMBIGUATION_RULES, INSTITUTION_KEYS, LANG_BASES, LITERAL, LOOSE, LangPrefsMap, MODULE_MACROS, MODULE_TYPES, MULTI_FIELDS, NAME_ATTRIBUTES, NAME_PARTS, NAME_VARIABLES, NONE, NUMERIC, NUMERIC_VARIABLES, POSITION, POSITION_CONTAINER_SUBSEQUENT, POSITION_FIRST, POSITION_IBID, POSITION_IBID_WITH_LOCATOR, POSITION_MAP, POSITION_SUBSEQUENT, POSITION_TEST_VARS, PREVIEW, PROCESSOR_VERSION, ROMAN_NUMERALS, SEEN, SINGLETON, SKIP_WORDS, START, STRICT, SUCCESSOR, SUCCESSOR_OF_SUCCESSOR, SUFFIX_CHARS, SUPPRESS, SWAPPING_PUNCTUATION, SYS_OPTIONS, TERMINAL_PUNCTUATION, TOLERANT, TRIGRAPH, VARIABLES_WITH_SHORT_FORM;
var init_core = __esm({
  "src/constants/core.ts"() {
    AREAS = ["citation", "citation_sort", "bibliography", "bibliography_sort", "intext"];
    ASCENDING = 2;
...
var _XmlJSON, XmlJSON;
var init_xmljson = __esm({
  "src/xml/xmljson.ts"() {
    init_core();
    _XmlJSON = class _XmlJSON {
      constructor(dataObj) {
...
var DateParser, dateParserInstance;
...
var LOCATOR_LABELS_MAP, STATUTE_SUBDIV_STRINGS, STATUTE_SUBDIV_STRINGS_REVERSE;
var init_statute = __esm({
  "src/constants/statute.ts"() {
    LOCATOR_LABELS_MAP = {
      "vrs": "verse",
      "sv": "sub-verbo",
...
var LongOrdinalizer, Ordinalizer, Romanizer, Suffixator;
var init_number = __esm({
  "src/util/number.ts"() {
    init_csl();
    init_core();
    init_statute();
    LongOrdinalizer = class {
      constructor() {
...
// src/engine/state.ts
var Opt, Tmp, Fun, Build, Configure, Citation, Bibliography, BibliographySort, CitationSort, InText;
...
var KATAKANA_REGEXP, LOCATOR_LABELS_REGEXP, ROMANESQUE_NOT_REGEXP, ROMANESQUE_REGEXP, STARTSWITH_KATAKANA_REGEXP, STARTSWITH_ROMANESQUE_REGEXP, STATUTE_SUBDIV_PLAIN_REGEX, STATUTE_SUBDIV_PLAIN_REGEX_FRONT, SUPERSCRIPTS, SUPERSCRIPTS_REGEXP, TITLE_SPLIT_REGEXP, VIETNAMESE_NAMES, VIETNAMESE_SPECIALS, PARTICLE_GIVEN_REGEXP, PARTICLE_FAMILY_REGEXP;
...
var init_institutionpart = __esm({
  "src/node/institutionpart.ts"() {
    Node_institution_part = {
      build: function(state, target) {
        let func;
          ...
          if (NAME_VARIABLES.indexOf(variable) > -1) {
            ...
            if (NUMERIC_VARIABLES.indexOf(variable) > -1) {
              ...
              func = function(state2, Item, item) {
                ...
                const cls = CSL.GET_COURT_CLASS(state2, Item, true);
      ...
      build: function(state, target) {
        if (this.strings.term) {
          let func = function(state2, Item, item) {
            let termtxt = CSL.evaluateLabel(this, state2, Item, item);
          ...
          if (state.build.area === "citation") {
            ...
            func = function(state2, Item, item) {
              if (item && item.prefix) {
                ...
                const ignorePredecessor = CSL.checkIgnorePredecessor(state2, prefix);
        ...
        if (this.tokentype === END) {
          ...
          if (!this.locale_raw) {
            ...
            if (state.build.area === "citation") {
              ...
              func = function(state2, Item, item) {
                if (item && item.suffix) {
                  let suffix = CSL.checkSuffixSpacePrepend(state2, item.suffix);
                  if (!state2.tmp.just_looking) {
        ...
        if (this.tokentype === START) {
          ...
          let func = function(state2, Item) {
            ...
            if (Item["language-name"] && Item["language-name-original"]) {
              ...
              const langspec = CSL.localeResolve(newItem.language, state2.opt["default-locale"][0]);
...
var init_alternativetext = __esm({
  "src/node/alternativetext.ts"() {
    init_csl();
    init_core();
    Node_alternative_text = {
      build: function(state, target) {
        if (this.tokentype === SINGLETON) {
          let func = function(state2, Item) {
        ...
        if (variables[0] !== "authority") {
          ...
          if (nameobjs) {
            for (let i2 = 0, ilen2 = nameobjs.length; i2 < ilen2; i2 += 1) {
              const substring = CSL.Util.Names.getRawName(nameobjs[i2]);
              if (substring) {
...
var PublisherOutput;
var init_publishers = __esm({
  "src/util/publishers.ts"() {
    init_csl();
    PublisherOutput = class {
        ...
        if (this.tokentype === START) {
          ...
          let func = function(state2, Item) {
            if (state2.opt.has_layout_locale) {
              const langspec = CSL.localeResolve(Item.language, state2.opt["default-locale"][0]);
      ...
      if (this.name === "layout") {
        ...
        if (this.tokentype === START) {
          ...
          for (let i2 = 1, ilen2 = locales.length; i2 < ilen2; i2 += 1) {
            const localeServant = CSL.localeResolve(locales[i2], locale_default);
...
// src/obj/number.ts
var NumericBlob, Output_DefaultFormatter;
...
var init_names2 = __esm({
  "src/util/names/index.ts"() {
    ...
    Util_Names.initializeWith = function(state, name, terminator, normalizeOnly) {
      ...
      const nameSplits = CSL.Output.Formatters.nameDoppel.split(name);
      let namelist = [];
    ...
    function Stack2(blob2) {
      ...
      this.addStyling = function(str, decor) {
        ...
        if (decor) {
          ...
          this.latest = newblob;
          if (str) {
            const tok2 = new CSL.Token();
            const newblob2 = new CSL.Blob(null, tok2);
            newblob2.blobs = str;
...
var OutputFormats, Output_formats;
var init_formats = __esm({
  "src/output/formats.ts"() {
    ...
    Output_formats = new OutputFormats();
  }
});
...
var ParticleList, parseParticles;
var init_name_particles = __esm({
  "src/util/name_particles.ts"() {
    init_regex();
    ParticleList = /* @__PURE__ */ (function() {
    ...
    parseParticles = /* @__PURE__ */ (function() {
...
var require_index = __commonJS({
  "src/index.ts"(exports, module) {
    ...
    init_info();
    init_institution();
    init_institutionpart();
    init_key();
    init_label();
    init_layout();
    init_macro();
    init_alternative();
    init_alternativetext();
    init_output();
    init_tests();
    init_truncate();
    init_divide();
